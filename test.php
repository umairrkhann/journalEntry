...
<body>
  ...
  <script>
          ...
          <div class="col-md-2 style:"text-align:center;" >
             ...
             <div class="col-md-2 style:"text-align:center;">
                ...
                <select class="form-select" id="costCenter" name="costCenter[]">
                  ...
                  <!-- Add your cost center options here -->
                </select>
              </div>
              <div class="col-md-2 style:"text-align:center;">
    ...
    //       const nexxt = btn.closest("tr").nextElementSibling;
    //       if (nexxt.style.display === "") {
    //         nexxt.style.display = "none";
    //       }
    //       btn.closest("tr").remove();
    //       const tbodyEl = document.querySelector('#costDiv');
    //       tbodyEl.remove();
    //     }
    //     // else if (e.target.classList.contains()) {
    //     //   console.log("jeee");
    //     //   // e.preventDefault();
    //     //   // toggleCostCenterDetails(e.target);
    //     //   // const tbodyEl = document.querySelector('#costDiv');
    //     //   // tbodyEl.style.display = tbodyEl.style.display === "none" ? "" : "none";
    //     // }
    //   });
    // }
    ...
    // function toggleCostCenterDetails(button) {
    //   const costCenterDetailsRow = button.closest("tr").nextElementSibling;
    //   costCenterDetailsRow.style.display = costCenterDetailsRow.style.display === "none" ? "" : "none";

    //   if (costCenterDetailsRow.style.display === "none") {
    //     button.children[0].classList.remove('bi-minus');
    //     button.children[0].classList.add('bi-plus');
    //   } else {
    //     button.children[0].classList.remove('bi-plus');
    //     button.children[0].classList.add('bi-minus');
    //   }
    // }
